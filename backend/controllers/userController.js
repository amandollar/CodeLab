...
const signUp = async (req, res) => {
    ...
    try {
        ...
        const hasedPassword = await bcrpyt.hash(password, salt);
...
const login = async (req, res) => {
    ...
    const pass = await bcrpyt.compare(password, user.password);
...
const updateProfile = async (req, res) => {
    ...
    try {
        ...
        const udpdatedUser = await User.findByIdAndUpdate(id, {
            email: email,
