...
const createRepository = async (req, res) => {
    try {
        ...
        const { owner, name, description, content, visibilty, issues } = req.body;
        ...
        const newRepository = new Repository({
            name, description, visibilty, owner, content, issues
        });
...
export { createRepository, getAllRepository, fetchRepoById, fetchRepoForCurrentUser, updateRepoById, deleteRepoById, toggleVisibiltyRepo };